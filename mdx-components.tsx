...
const components: MDXComponents = {
  ...
  h2: (props: HeadingProps) => <h2 className="text-red-800 font-medium mt-8 mb-3" {...props} />,
  ...
  pre: (props: PreProps) => <pre className="overflow-auto p-4 bg-gray-100 rounded" {...props} />,
  inlineCode: (props: InlineCodeProps) => <code className="bg-gray-100 rounded px-1" {...props} />,
  ...
  hr: (props: HrProps) => <hr className="my-8 border-t border-gray-300" {...props} />,

  del: (props: DeleteProps) => <del className="line-through text-gray-500" {...props} />,

  sup: (props: ComponentPropsWithoutRef<"sup">) => <sup className="text-xs" {...props} />,

  sub: (props: ComponentPropsWithoutRef<"sub">) => <sub className="text-xs" {...props} />,

  details: (props: ComponentPropsWithoutRef<"details">) => <details className="my-4" {...props} />,

  summary: (props: ComponentPropsWithoutRef<"summary">) => (
    <summary className="cursor-pointer font-medium" {...props} />
  ),
  table: (props: TableProps) => <table className="min-w-full border-collapse my-4" {...props} />,
  ...
  tr: (props: ComponentPropsWithoutRef<"tr">) => <tr className="hover:bg-gray-50" {...props} />,
